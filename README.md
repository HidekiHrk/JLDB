![logo](https://raw.githubusercontent.com/HidekiHrk/JLDB/master/logo.png)<br>
***
...
JLDB Is a NoSQL DataBase based on JSON format, but using dict syntax for a more friendly relation with python code.
